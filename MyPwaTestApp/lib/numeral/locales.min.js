 ...
 */
!function(a, b) { "function" == typeof define && define.amd ? define(["numeral"], b) : b("object" == typeof module && module.exports ? require("./numeral") : a.numeral) }(this, function(a)
{
    !function()
    {
    ...
    function()
    {
        a.register("locale", "es-es", {
            ...
            ordinal: function(a) { var b = a % 10; return 1 === b || 3 === b ? "er" : 2 === b ? "do" : 7 === b || 0 === b ? "mo" : 8 === b ? "vo" : 9 === b ? "no" : "to" },
            currency: { symbol: "€" }
        })
    }(),
    function()
    ...
    function()
    {
        a.register("locale", "fr-ca", {
            delimiters: { thousands: " ", decimal: "," },
            abbreviations: { thousand: "k", million: "M", billion: "G", trillion: "T" },
            ordinal: function(a) { return 1 === a ? "er" : "e" },
            currency: { symbol: "$" }
        })
    }(),
    function()
    ...
    function()
    {
        a.register("locale", "nl-be", {
            ...
            ordinal: function(a) { var b = a % 100; return 0 !== a && 1 >= b || 8 === b || b >= 20 ? "ste" : "de" },
            currency: { symbol: "€ " }
        })
    }(),
    function()
    ...
    function()
    {
        ...
        a.register("locale", "tr", {
            ...
            ordinal: function(a)
            {
                if (0 === a) return "'ıncı"; var c = a % 10, d = a % 100 - c, e = a >= 100 ? 100 : null; return b[c] || b[d] || b[e]
            },
            currency: { symbol: "₺" }
        })
    }(),
